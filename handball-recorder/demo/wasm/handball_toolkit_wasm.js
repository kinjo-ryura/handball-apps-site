/* @ts-self-types="./handball_toolkit_wasm.d.ts" */
 ...
 * @returns {string}
 */
export function buildMatchView(slug, json, new_ids) {
    let deferred5_0;
    let deferred5_1;
    try {
        ...
        const ptr2 = passArrayJsValueToWasm0(new_ids, wasm.__wbindgen_malloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.buildMatchView(ptr0, len0, ptr1, len1, ptr2, len2);
        var ptr4 = ret[0];
        var len4 = ret[1];
        if (ret[3]) {
            ptr4 = 0; len4 = 0;
 ...
 * @returns {number}
 */
export function requiredIdCount(json) {
    const ptr0 = passStringToWasm0(json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.requiredIdCount(ptr0, len0);
    if (ret[2]) {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./handball_toolkit_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('handball_toolkit_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
